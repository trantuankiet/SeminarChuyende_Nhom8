<?php /* Smarty version Smarty-3.1.19, created on 2014-10-02 23:48:52
         compiled from "/home/u163028367/public_html/modules/prediggo/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2115853931542d81f471fe76-70172892%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8e9ea1e0d72d47a7f7bd14392e4224e757a56c1e' => 
    array (
      0 => '/home/u163028367/public_html/modules/prediggo/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1412268531,
      2 => 'file',
    ),
    '4b5c78f38b42eb75e90f39e947de062723f7eba0' => 
    array (
      0 => '/home/u163028367/public_html/admin5999/themes/default/template/helpers/form/form.tpl',
      1 => 1411792357,
      2 => 'file',
    ),
    'a58cd281a3c477972466886b960aca4d440341bf' => 
    array (
      0 => '/home/u163028367/public_html/admin5999/themes/default/template/helpers/form/form_group.tpl',
      1 => 1411792358,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2115853931542d81f471fe76-70172892',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_542d81f5521b95_91461233',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_542d81f5521b95_91461233')) {function content_542d81f5521b95_91461233($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/u163028367/public_html/tools/smarty/plugins/function.counter.php';
?>
...
?>
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='hint') {?>
		<div class="hint" style="display:block;margin-bottom:20px;">
			<?php echo $_smarty_tpl->tpl_vars['input']->value['content'];?>
...
<?php } else { ?>9<?php }?> <?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?>col-lg-offset-3<?php }?>">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='button') {?>
    	<input type="submit" name="<?php echo $_smarty_tpl->tpl_vars['input']->value['name'];?>
" 
    	<?php if (isset($_smarty_tpl->tpl_vars['input']->value['class'])&&$_smarty_tpl->tpl_vars['input']->value['class']) {?>class="<?php echo $_smarty_tpl->tpl_vars['input']->value['class'];?>
"<?php }?>  
    	<?php if (isset($_smarty_tpl->tpl_vars['input']->value['disabled'])&&$_smarty_tpl->tpl_vars['input']->value['disabled']) {?>disabled="disabled"<?php }?> 
    	value="<?php echo $_smarty_tpl->tpl_vars['input']->value['title'];?>
">
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='attribute_selector') {?>
		<ul id="prediggo_attributes">
			<?php  $_smarty_tpl->tpl_vars["aGroupAttribute"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["aGroupAttribute"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['values']['attributes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["aGroupAttribute"]->key => $_smarty_tpl->tpl_vars["aGroupAttribute"]->value) {
$_smarty_tpl->tpl_vars["aGroupAttribute"]->_loop = true;
?>
				<li>
					<input type="checkbox" name="<?php echo $_smarty_tpl->tpl_vars['input']->value['names']['attributes'];?>
" value="<?php echo intval($_smarty_tpl->tpl_vars['aGroupAttribute']->value['id_attribute_group']);?>
" <?php if (in_array(intval($_smarty_tpl->tpl_vars['aGroupAttribute']->value['id_attribute_group']),$_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']]['attributes'])) {?>checked="checked"<?php }?> <?php if (isset($_smarty_tpl->tpl_vars['input']->value['disabled'])&&$_smarty_tpl->tpl_vars['input']->value['disabled']) {?>disabled="disabled"<?php }?> />
					<?php echo smartyTranslate(array('s'=>'Group of Attributes:','mod'=>'prediggo'),$_smarty_tpl);?>
 <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['aGroupAttribute']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>

				</li>
			<?php } ?>
	
			<?php  $_smarty_tpl->tpl_vars["aFeature"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["aFeature"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['values']['features']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["aFeature"]->key => $_smarty_tpl->tpl_vars["aFeature"]->value) {
$_smarty_tpl->tpl_vars["aFeature"]->_loop = true;
?>
				<li>
					<input type="checkbox" name="<?php echo $_smarty_tpl->tpl_vars['input']->value['names']['features'];?>
" value="<?php echo intval($_smarty_tpl->tpl_vars['aFeature']->value['id_feature']);?>
" <?php if (in_array(intval($_smarty_tpl->tpl_vars['aFeature']->value['id_feature']),$_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']]['features'])) {?>checked="checked"<?php }?> <?php if (isset($_smarty_tpl->tpl_vars['input']->value['disabled'])&&$_smarty_tpl->tpl_vars['input']->value['disabled']) {?>disabled="disabled"<?php }?> />
					<?php echo smartyTranslate(array('s'=>'Feature:','mod'=>'prediggo'),$_smarty_tpl);?>
 <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['aFeature']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>

				</li>
			<?php } ?>
		</ul>
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='autocomplete') {?>
		<input type="hidden" name="input_<?php echo $_smarty_tpl->tpl_vars['input']->value['name'];?>
" id="input_<?php echo $_smarty_tpl->tpl_vars['input']->value['name'];?>
" value="<?php  $_smarty_tpl->tpl_vars['element'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['element']->_loop = false;
...
"<?php }?>
					<?php if (isset($_smarty_tpl->tpl_vars['input']->value['disabled'])&&$_smarty_tpl->tpl_vars['input']->value['disabled']) {?>disabled="disabled"<?php }?> />
				<?php echo smartyTranslate(array('s'=>'Begin typing the first letters, then select the element from the drop-down list','mod'=>'prediggo'),$_smarty_tpl);?>

			</p>
			<p class="preference_description"><?php echo smartyTranslate(array('s'=>'(Do not forget to save the product afterward)','mod'=>'prediggo'),$_smarty_tpl);?>
</p>
		</div>
				
		<ul id="ul_<?php echo $_smarty_tpl->tpl_vars['input']->value['name'];?>
">
			<?php if (count($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']])) {?>
				<?php  $_smarty_tpl->tpl_vars['element'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['element']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['element']->key => $_smarty_tpl->tpl_vars['element']->value) {
$_smarty_tpl->tpl_vars['element']->_loop = true;
?>
					<li class="deleteElement" name="<?php echo $_smarty_tpl->tpl_vars['element']->value['id'];?>
" style="cursor: pointer;">
						<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '2115853931542d81f471fe76-70172892');
content_542d81f5209b51_24341847($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2014-10-02 23:48:53
         compiled from "/home/u163028367/public_html/admin5999/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_542d81f5209b51_24341847')) {function content_542d81f5209b51_24341847($_smarty_tpl) {?>
